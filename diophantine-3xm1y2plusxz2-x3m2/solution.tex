...
\fancyhf{}
\rhead{\small\thepage}
\lhead{\small Partial Obstruction Proof for $(3x-1) \cdot y^2 + xz^2 = x^3 - 2$}
...
Lean~4/Mathlib~4 with \textbf{zero additional axioms}; one \texttt{sorry}
...
\texttt{no\_solution\_case1}  & $x \equiv 1 \pmod{3}$: no integer solution      & \texttt{sorry} (open) \\
